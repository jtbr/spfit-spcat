...
#define NDLINE 128
    ...
    luegy = file_helpers::open_output(cfil[elgy], "w");
    ...
    tagv = (int *) calalloc((size_t) ndtag * sizeof(int));
...
EGYS *lposn(short *ikey, const int nkey, int *iret)
{
  EGYS *now, *plast;
  short *iqnx;
  int k, icmp, iord;
...
void emove(EGYS *pold, EGYS *pend)
{
